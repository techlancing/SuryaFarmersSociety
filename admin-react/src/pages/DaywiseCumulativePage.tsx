...
export function DaywiseCumulativePage() {
  ...
  return (
    <div className="page">
      <Typography variant="h5" gutterBottom>Day Wise Cumulative</Typography>
      <Typography variant="body2" color="text.secondary" gutterBottom>
        Select date range. To date must be on or after from date.
      </Typography>
        ...
        {showReport && (
          <Card elevation={0} sx={{ mb: 2, borderRadius: 2, border: '1px solid #e5e7eb' }} className="report-print-area">
            <CardContent>
              ...
              <Typography variant="subtitle2" gutterBottom>Account Transactions (Day-wise Cumulative)</Typography>
              <Table size="small">
                <TableHead>
                  <TableRow>
