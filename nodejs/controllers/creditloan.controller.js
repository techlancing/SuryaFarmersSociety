          ...
          if(todayDate > loanPenaltyDate ){
            ...
            if(olasttransaction.length > 0) {
                ...
                if (accountBalance > 0) {
                  ...
                  let creditamt = olasttransaction[0].nBalanceAmount * oLoan.nIntrest/100 * 1/12;
                  oTransaction.nCreditAmount = Math.round((creditamt + Number.EPSILON) * 100)/100;
                  oTransaction.nDebitAmount = 0;
                  let balamt = olasttransaction[0].nBalanceAmount + oTransaction.nCreditAmount;
                  oTransaction.nBalanceAmount = Math.round((balamt + Number.EPSILON) * 100)/100;
