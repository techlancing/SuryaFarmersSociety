...
import { DaywiseCumulative } from '../../../core/models/daywisecumulative.model'
...
export class DaywiseCumulativeComponent implements OnInit {
  ...
  bankaccounts: Array<DaywiseCumulative>;

  @Output() updateClicked = new EventEmitter();
  @Output() addClicked = new EventEmitter();
  @Input() oEditBankAccount: DaywiseCumulative;

  public odaywisecumulativemodel: DaywiseCumulative;
  ...
  aTypeofLoan: { displayText: string; value: string; }[];
   ...
   ngOnInit(): void {
     ...
     this.odaywisecumulativemodel = new DaywiseCumulative();
