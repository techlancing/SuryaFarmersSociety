...
import { LastTransaction } from '../../../core/models/lasttransactionreport.model'
...
export class LastTransactionComponent implements OnInit {
  ...
  @Input() oEditBankAccount: LastTransaction;

  public olasttransactionreportmodel: LastTransaction;
  ...
  ngOnInit(): void {
    ...
    this.olasttransactionreportmodel = new LastTransaction();
