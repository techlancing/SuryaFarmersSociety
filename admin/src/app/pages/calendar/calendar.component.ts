...
export class CalendarComponent implements OnInit {
  ...
  // calendar plugin
  calendarPlugins = [dayGridPlugin, bootstrapPlugin, timeGridPlugin, interactionPlugin, listPlugin];

  constructor(private modalService: NgbModal, private formBuilder: FormBuilder, public loader: LoaderService, public http: HttpClient) {
  }
